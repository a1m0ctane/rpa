namespace: Demo
operation:
  name: RegisterUserAOS
  inputs:
    - user: SparDemo
    - email: spar.demo@microfocus.com
  sequential_action:
    gav: 'com.microfocus.seq:Demo.RegisterUserAOS:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      ...
      - step:
          id: '11'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("phone_numberRegisterPage")'
          action: Set
          default_args: '"004376765894"'
          snapshot: ".\\Snapshots\\ssf10.html"
          highlight_id: '10000000'
      - step:
          id: '12'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("City")'
          action: Click
          snapshot: ".\\Snapshots\\ssf11.html"
          highlight_id: '10000000'
      - step:
          id: '13'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("cityRegisterPage")'
          action: Set
          default_args: '"Vienna"'
      ...
      - step:
          id: '14'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("addressRegisterPage")'
          action: Set
          default_args: '"Ueberlandstrasse"'
          snapshot: ".\\Snapshots\\ssf13.html"
          highlight_id: '10000000'
      - step:
          id: '15'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("postal_codeRegisterPage")'
          action: Set
          default_args: '"1010"'
              ...
              child_objects:
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//SEC-VIEW/DIV[normalize-space()="City"]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                    ...
                    class: WebElement
                    visual_relations: ''
                    last_update_time: 'Thursday, April 30, 2020 2:42:26 PM'
